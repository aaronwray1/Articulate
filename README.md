...
| The web application current Cross Origin Resource Sharing policy allows for any origin to have access to resources within the web app. This could lead to cross domain based attacks.                                                           | Low        | High     | Prevent         | Restrict the web application from interacting with resources outside of its domain by applying srticter CORS policies that ony allow access from specific origins or http requests with specific headers. | 07/2021      |
...
| An adversary is able to obtain my Azure/DockerHub credentials                                                                                                                                                                                   | Low        | High     | Prevent         | All credential used with in the runner are injected using GitHub Secrets, which are encrypted environment variables                                                                                       | 07/2021      |
