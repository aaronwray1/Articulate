...
| An adversary is able to obtain my Azure and Docker Hub                                                                                                                                                                                          | Low        | High     | Prevent         | All credential used with in the runner are injected using GitHub Secrets, which are encrypted environment variables                                                                                       | 07/2021      |
